import { rt as updatePurchaseInvoice } from "./clients-DsHCc4c7.js";
...
//#region src/routes/purchaseinvoice.tsx?tsr-split=component
var STATUS_OPTIONS = [
	"All",
	"Draft",
	"Generated",
...
function PurchaseInvoicesPage() {
	...
	function exportExcelData() {
		exportExcel("Purchase Invoices Register", [
			"Bill No",
			"Date",
			"Supplier",
			"Sub Total",
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				toolbar: /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", {
					...
					className: "text-xs text-muted-foreground",
					children: [visible.length, " bills found"]
				})] }),
				children: /* @__PURE__ */ jsxs(Table, { children: [/* @__PURE__ */ jsx(TableHeader, { children: /* @__PURE__ */ jsxs(TableRow, { children: [
					...
					children: [visible.length === 0 && /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsx(TableCell, {
						...
						children: "No purchase invoices found matching the filters."
					}) }), visible.map((inv) => {
						...
						return /* @__PURE__ */ jsxs(TableRow, {
							...
							children: [
								...
								/* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(Badge, {
									variant: "outline",
									className: inv.status === "Draft" ? "bg-muted text-muted-foreground" : inv.status === "Generated" ? "bg-primary/15 text-primary border-primary/30" : "bg-success/15 text-success border-success/30",
...
//#endregion
export { PurchaseInvoicesPage as component };
